...
var reviewedInPlaceByteWrites = map[string]reviewedInPlaceByteWrite{
	...
	"internal/schannel/conn_windows.go":                     {2, "copies the ALPN list and one plaintext chunk into freshly allocated SChannel buffers; no caller payload byte is rewritten"},
}
